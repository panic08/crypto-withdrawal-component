...
public interface VkAuthorizationRequestToUserActivityMapper {
    @Mappings({
    ...
    UserActivity vkAuthorizationRequestToUserActivity(VkAuthorizationRequest vkAuthorizationRequest);
}
