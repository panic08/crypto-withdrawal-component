...
public interface CryptoReplenishmentEthRequestToCryptoReplenishmentMessageMapper {
    @Mappings({
            ...
            @Mapping(constant = "ETH", target = "currency"),
    ...
    CryptoReplenishmentMessage cryptoReplenishmentEthRequestToCryptoReplenishmentMessage(CryptoReplenishmentEthRequest cryptoReplenishmentEthRequest);
}
