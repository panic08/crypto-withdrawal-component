...
import com.casino.replenishments.mapper.CryptoReplenishmentEthRequestToCryptoReplenishmentMessageMapperImpl;
import com.casino.replenishments.mapper.CryptoReplenishmentMessageToCryptoReplenishmentResponseMapperImpl;
import com.casino.replenishments.mapper.CryptoReplenishmentTrxRequestToCryptoReplenishmentMessageMapperImpl;
...
public class CryptoReplenishmentServiceImpl implements CryptoReplenishmentService {
    ...
    private final CryptoReplenishmentTrxRequestToCryptoReplenishmentMessageMapperImpl cryptoReplenishmentTrxRequestToCryptoReplenishmentMessageMapper;
    private final CryptoReplenishmentEthRequestToCryptoReplenishmentMessageMapperImpl cryptoReplenishmentEthRequestToCryptoReplenishmentMessageMapper;
    ...
    public Mono<CryptoReplenishmentResponse> createTrxCryptoReplenishment(String authorization, CryptoReplenishmentTrxRequest cryptoReplenishmentTrxRequest) {
        ...
        return userMono
                .flatMap(user -> findCryptoReplenishmentSessionByUserIdAndCurrency(user.getId(), CryptoReplenishmentSessionCurrency.TRX))
                .defaultIfEmpty(new CryptoReplenishmentSession())
                .filter(cryptoReplenishmentSession -> cryptoReplenishmentSession.getUntilTimestamp() == null)
                .switchIfEmpty(Mono.error(new IncorrectTokenProvidedException("Complete previous crypto-replenishment")))
                .flatMap(cryptoReplenishmentSession22 -> Mono.zip(userMono, generateCryptoData(GET_TRX_GENERATE_CRYPTO_DATA_URL))
                        .flatMap(tuple -> {
                            ...
                            cryptoReplenishmentSession.setAmount(cryptoReplenishmentTrxRequest.getAmount());
                            ...
                            return saveCryptoReplenishmentSession(cryptoReplenishmentSession)
                                    .map(cryptoReplenishmentSession1 -> {
                                        CryptoReplenishmentMessage cryptoReplenishmentMessage =
                                                cryptoReplenishmentTrxRequestToCryptoReplenishmentMessageMapper
                                                        .cryptoReplenishmentTrxRequestToCryptoReplenishmentMessage(cryptoReplenishmentTrxRequest);
    ...
    public Mono<CryptoReplenishmentResponse> createEthCryptoReplenishment(String authorization, CryptoReplenishmentEthRequest cryptoReplenishmentEthRequest) {
        ...
        return userMono
                .flatMap(user -> findCryptoReplenishmentSessionByUserIdAndCurrency(user.getId(), CryptoReplenishmentSessionCurrency.ETH))
                .defaultIfEmpty(new CryptoReplenishmentSession())
                .filter(cryptoReplenishmentSession -> cryptoReplenishmentSession.getUntilTimestamp() == null)
                .switchIfEmpty(Mono.error(new IncorrectTokenProvidedException("Complete previous crypto-replenishment")))
                .flatMap(cryptoReplenishmentSession22 -> Mono.zip(userMono, generateCryptoData(GET_ETH_GENERATE_CRYPTO_DATA_URL))
                        .flatMap(tuple -> {
                            ...
                            cryptoReplenishmentSession.setUserId(tuple.getT1().getId());
                            cryptoReplenishmentSession.setRecipientAddress(tuple.getT2().getAddress());
                            cryptoReplenishmentSession.setAmount(cryptoReplenishmentEthRequest.getAmount());
                            ...
                            return saveCryptoReplenishmentSession(cryptoReplenishmentSession)
                                    .map(cryptoReplenishmentSession1 -> {
                                        CryptoReplenishmentMessage cryptoReplenishmentMessage =
                                                cryptoReplenishmentEthRequestToCryptoReplenishmentMessageMapper
                                                        .cryptoReplenishmentEthRequestToCryptoReplenishmentMessage(cryptoReplenishmentEthRequest);
